...
class TaskTestCase(unittest.TestCase):
  ...
  def test_list_user_Task(self):
    ...
    company1.put()
    task1 = Task(title = "Name", create_by= user1, attach_users = [user1, user2], company = company1)
    task1.put()
  ...
  #   task1 = Task(title = "Name", create_by= user1, attach_users = [user1, user2], company = company1)
  #   task1.put()
  #   task2 = Task(title = "Name2", create_by= user1, attach_users = [user1, user2], company = company1)
  #   task2.put()
  #   task3 = Task(title = "Name3", create_by= user1, attach_users = [user1, user2], company = company2)
  #   task3.put()
  #   task4 = Task(title = "Name4", create_by= user1, attach_users = [user1, user2], company = company2)
  #   task4.put()
